...
class ParkingLotTest {
    ...
    fun setUp() {
        ...
        // Set up entrances with prioritized spaces for each vehicle type
        val entrance1 = Entrance("E1")
        val entrance2 = Entrance("E2")

        // Initialize parking lot with one floor and two entrances
        parkingLot = ParkingLot(listOf(floor1), listOf(entrance1, entrance2))
    }
    ...
    fun testRemoveVehicleAndFreeSpot() {
        ...
        // Remove vehicle
        val fee = parkingLot.removeVehicle(ticket!!.ticketId)
    ...
    fun testAssignDifferentSpotForDifferentVehicleType() {
        ...
        // Add a bus, which should get the bus spot (space S3)
        val ticket = parkingLot.addVehicle(vehicle, "E1")
